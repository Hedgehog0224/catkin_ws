...
## UART
*Universal Asнnсhronous Receiver-Transmitter* (*Универсльный асинхронный приёмопередатчик*) - это  и протокол передачи данных и аппаратное устройство (или схема), используемое для последовательной связи между двумя устройствами.
...
![Image_0](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-00.png)\
*Без бита чётности*

![Image_2](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-02.png)\
*С битом чётности*
...
![Image_1](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-01.png)
...
В отличие от UART, **I2C** является протоколом **синхронной** связи, это означает, что обмен данными происходит по общему для всех связанных устройств сигналу синхронизации. В положительную сторону отличается от UART более высокой скоростью стабильной передачи данных и более стабильной передачей данных на высокой скорости.\
...
![Image_3](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-03.jpg)
...
![Image_5](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-05.jpg)

Вследствие различных технологий микросхем (КМОП, НМОП, биполярная), которые могут быть подключены к шине, уровни логического **0** (НИЗКИЙ) и логической **1** (ВЫСОКИЙ) не фиксированы и зависят от соответствующего уровня **Vdd**. Один синхроимпульс генерируется на каждый пересылаемый бит.\
...
| Multi-master		| ----------	| Несолько ведущих могут пытаться захватить шину одновременно, без нарушения передаваемой информации    |
...
![Image_4](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-04.jpg)
...
![Image_6](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-06.jpg)
...
![Image_7](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-07.jpg)
...
![Image_8](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-08.jpg)

![Image_9](https://github.com/Hedgehog0224/catkin_ws/blob/docs/Documentation/Images/003-4-09.jpg)
